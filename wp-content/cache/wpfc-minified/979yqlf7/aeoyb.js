// source --> https://www.bluekey.com/wp-content/plugins/google-analytics-premium/assets/js/frontend.js?ver=1597480086 
/**
 * Developer's Notice:
 *
...
// source --> https://www.bluekey.com/wp-includes/js/jquery/jquery.js?ver=1.12.4-wp 
...
jQuery.noConflict();
// source --> https://www.bluekey.com/wp-includes/js/jquery/jquery-migrate.js?ver=3.3.2 
/*!
...
// source --> https://www.bluekey.com/wp-content/plugins/wp-skype-contact-button/js//wpscb-frontend.js?ver=1.0.3 
jQuery(document).ready(function($) {
	...
	$('body').on('click','.wpscb-button-tooltip-wrap', function(){
	    ...
	    if( $(this).attr("data-status") == 'clicked' ) {
	        ...
	        $(this).attr("data-status","not_clicked"); 
 ...
 //    $(document).on('click', function (e) {
	//     if ($(e.target).closest("#wpscb-button-tooltip-wrap").length === 0) {
	//         if( $("#wpscb-button-tooltip-wrap").attr("data-status") == 'clicked' ) {
	// 	        $("#wpscb-button-tooltip-wrap").attr("data-status","not_clicked");
	//         	$('#wpscb-button-tooltip-wrap').closest('.wpscb-text-inner-wrapper').find('.wpscb-all-buttons-container').css("display", "none");
	// 	    }
	//     }
	//     if ($(e.target).closest(".wpscb-button-tooltip-wrap-menu").length === 0) {
	//     	alert('hello');
	//         if( $(".wpscb-button-tooltip-wrap-menu").attr("data-status") == 'clicked' ) {
	// 	        $(".wpscb-button-tooltip-wrap-menu").attr("data-status","not_clicked");
	//         	$('.wpscb-button-tooltip-wrap-menu').closest('.wpscb-text-inner-wrapper').find('.wpscb-all-buttons-container').css("display", "none");
	// 	    }
	//     }
	// });
});
// source --> https://www.bluekey.com/wp-content/plugins/wp-gdpr-compliance/assets/vendor/micromodal/micromodal.min.js?ver=1591711726 
...
// source --> https://www.bluekey.com/wp-content/plugins/wp-gdpr-compliance/assets/vendor/postscribe/postscribe.min.js?ver=1591711726 
/**
 * @file postscribe
...
// source --> https://www.bluekey.com/wp-content/plugins/ts-visual-composer-extend/js/jquery.vcsc.modernizr.min.js?ver=5.5 
